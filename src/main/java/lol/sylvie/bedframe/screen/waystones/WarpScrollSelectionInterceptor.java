...
public final class WarpScrollSelectionInterceptor implements ScreenSourceInterceptor {

    @Override
    public boolean supports(ScreenOpenContext context) {
        return WaystonesFamilyRouter.WARP_SCROLL_SELECTION.equals(context.triggerId())
    ...
    @Override
    public String id() {
        return "waystones:warp_scroll_selection";
    }
}
